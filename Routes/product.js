...
const storage = multer.diskStorage({
    destination: (req,file, callBack)=>{
        callBack(null,"/mugerwademo/client/build/uploads")
    },
    ...
    try {
        ...
        if (req.file !== undefined) {
            ...
            if (req.file !== undefined && req.file.originalname !== singleProduct.image) {
                fs.unlink(`/mugerwademo/client/build/uploads/${singleProduct.image}`, (err)=>{console.log(err)})
...
router.delete('/delete/:id', async(req,res)=>{
    ...
    try {
        ...
        if (id) {
            ...
            fs.unlink(`/mugerwademo/client/build/uploads/${data.image}`, (err)=>{console.log(err)})
